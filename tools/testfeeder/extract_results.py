...
INDIVIDUAL = {
    "Kuchenreuter/O": ind("pistol", "original", "No 6 Kuchenreuter", "m25"),
    "Kuchenreuter/R": ind("pistol", "reproduction", "No 6 Kuchenreuter", "m25"),
    "Cominazzo(O/R)": ind("pistol", "combined", "No 5 Cominazzo", "m25"),
    "Tanzutsu(O/R)": ind("pistol", "combined", "No 28 Tanzutsu", "m25"),
    "Colt/O": ind("pistol", "original", "No 7 Colt", "m25"),
    "Mariette/R": ind("pistol", "reproduction", "No 12 Mariette", "m25"),
    "Donald Malson/O": ind("pistol", "original", "No 23 Donald Malson", "m50"),
    "Donald Malson/R": ind("pistol", "reproduction", "No 23 Donald Malson", "m50"),
    "Meixner/RS": ind("pistol", "reproduction", "Meixner RS", "m50"),
    "Meixner/RU": ind("pistol", "reproduction", "Meixner RU", "m50"),
    "Tanegashima(O/R)": ind("rifle", "combined", "No 14 Tanegashima", "m50"),
    "Hizadai(O/R)": ind("rifle", "combined", "No 16 Hizadai", "m50"),
    "Miquelet(O/R)": ind("rifle", "combined", "No 1 Miquelet", "m50"),
    "Vetterli/O": ind("rifle", "original", "No 15 Vetterli", "m50"),
    "Vetterli/R": ind("rifle", "reproduction", "No 15 Vetterli", "m50"),
    "Lamarmora(O/R)": ind("rifle", "combined", "No 37 Lamarmora", "m50"),
    "Pennsylvania(O/R)": ind("rifle", "combined", "No 36 Pennsylvania", "m50"),
    "Maximilian(O/R)": ind("rifle", "combined", "No 2 Maximilian", "m100"),
    "Minie(O/R)": ind("rifle", "combined", "No 3 Minie", "m100"),
    "Whitworth (O/R)": ind("rifle", "combined", "No 4 Whitworth", "m100"),
    "Kuchenreuter Junioren": ind("pistol", "combined", "No 6 Kuchenreuter Junioren", "m25"),
    "Mariette Junioren": ind("pistol", "combined", "No 12 Mariette Junioren", "m25"),
    "Vetterli Junioren": ind("rifle", "combined", "No 15 Vetterli Junioren", "m50"),
    "Whitworth Junioren": ind("rifle", "combined", "No 4 Whitworth Junioren", "m100"),
}

TEAMS = {
    "Boutet (Kuchenreuter/O)": team("pistol", "original", "No 18 Boutet", "No 6 Kuchenreuter"),
    "Forsyth (Kuchenreuter/R)": team("pistol", "reproduction", "No 33 Forsyth", "No 6 Kuchenreuter"),
    "Wogdon (Cominazzo-R/O)": team("pistol", "combined", "No 25 Wogdon", "No 5 Cominazzo"),
    "Kunitomo (Tanzutsu O/R)": team("pistol", "open", "No 39 Kunitomo", "No 28 Tanzutsu"),
    "Adams (Colt)": team("pistol", "original", "No 30 Adams", "No 7 Colt"),
    "Peterlongo (Mariette)": team("pistol", "reproduction", "No 13 Peterlongo", "No 12 Mariette"),
    "El Alamo (D.Malson O/R)": team("pistol", "open", "No 45 El Alamo", "Not specified"),
    "Springfield(MEI-R/O)": team("pistol", "open", "Springfield", "Meixner"),
    "Nagashino (Tanegash. O/R)": team("rifle", "combined", "No 19 Nagashino", "No 14 Tanegashima"),
    "Halikko (Miqelet O/R)": team("rifle", "combined", "No 31 Halikko", "No 1 Miquelet"),
    "Pforzheim (Vetterli-R/O)": team("rifle", "open", "No 24 Pforzheim", "No 15 Vetterli"),
    "Enfield (Lamarmora O/R)": team("rifle", "combined", "No 40 Enfield", "No 37 Lamarmora"),
    "Kossut (Pennsylvania O/R)": team("rifle", "open", "No 42 Kossuth", "No 36 Pennsylvania"),
    "Lucca (Maximilian-R/O)": team("rifle", "combined", "No 29 Lucca", "No 2 Maximilian"),
    "Magenta (Minie-R/O)": team("rifle", "combined", "No 32 Magenta", "No 3 Minie"),
    "Rigby (Whitworth-R/O)": team("rifle", "open", "No 20 Rigby", "No 4 Whitworth"),
}
